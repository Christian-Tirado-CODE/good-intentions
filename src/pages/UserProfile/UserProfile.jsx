      ...
      <div className={classes.UserProfile}>
        ...
        <div className={classes.Grid}>
          ...
          <div className={classes.Middle}>
            <div className={classes.Post}>
              ...
              <div className={classes.PostBody}>
                <div className={classes.PostText}>Juan Jiménez, Analista de Política Pública de Sembrando Sentido, reitera la importancia de la Oficina del Contralor y la necesidad de crear espacios participativos y de incidencia en su gestión y el camino que trazan para proteger nuestros recursos.</div>
                <div className={classes.PostImageContainer}> <img
          ...
          <div className={classes.Right}>
            <div className={classes.FeedFollows}>
                <h2>Add to your feed</h2>

                <div className={classes.Recommendation}>
                     <div className={classes.RecommendationLogo}></div>
                    <div>
                    <div className={classes.RecommendationName}>Foundation For Puerto Rico</div>
                    <div className={classes.RecommendationDescription}>Tourism</div>
                    <button className={classes.RecommendationFollowAction}> + Follow</button>
                    </div>
